// backend/data/supabase/quiz_queries.js
// ============================================================
// Quiz Queries — funciones de lectura de quiz, questions y answers
// Solo lectura, usa SUPABASE_SERVICE_KEY
...
async function getAllQuizzes() {
  try {
    ...
    console.error('[DB] Error en getAllQuizzes:', err.message);
    return [];
  }
}
